...
Applies to Nano Banana 2 and Nano Banana Pro generation and editing through any
...
- Identify each input with the exact mention supplied by the provider adapter
  and explain whether it supplies the source, identity, environment, style, or
  another visual role.
