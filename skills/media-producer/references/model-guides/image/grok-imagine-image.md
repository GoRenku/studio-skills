...
Applies to Grok Imagine Image generation and editing through any supported
provider route.
...
- Refer to selected inputs by the exact mentions supplied by the provider
  adapter and give each one a distinct visual role.
