...
Read `index.md` first. Use this only for a MiniMax H3 text-to-video operation,
when no exact media file should control the result.
...
- Does the prompt describe one achievable result for the selected duration?
