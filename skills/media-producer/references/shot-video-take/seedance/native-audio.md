...
Timing is best-effort inside native Seedance audio: the line should begin
during [beat/panel/shot], continue through [beat/panel/shot], and complete
during [beat/panel/shot].
```
...
- Does the prompt avoid promising exact timing?
