...
description: Design and persist Renku Studio Scene Shot Lists by reading scene screenplay context, referenced cast and locations, active Lookbook guidance, and user direction.
---
...
4. Translate user direction and active Lookbook guidance into concrete framing, movement, blocking, light, texture, subject, and editorial coverage choices.
...
Default shot-list work should stay text-first: screenplay blocks, referenced cast, referenced locations, project aspect ratio, active Lookbook text, and previous shot-list summary.
